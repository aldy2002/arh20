Vue.createApp({
    ...
    methods: {
        getHeaderData() {
            axios
                .get(
                    "https://raw.githubusercontent.com/aldy2002/arh20/main/assets/js/header.json"
                )
                .then((res) => {
        ...
        getAboutData() {
            axios
                .get(
                    "https://raw.githubusercontent.com/aldy2002/arh20/main/assets/js/about.json"
                )
                .then((res) => {
                    console.log(res.data); //melihat respon data pada console browser
        ...
        getArticlesData() {
            axios
                .get(
                    "https://raw.githubusercontent.com/aldy2002/arh20/main/content/articles.json"
                )
                .then((res) => {
                    console.log(res.data); //melihat respon data pada console browser
